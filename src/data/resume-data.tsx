...
export const RESUME_DATA = {
  ...
  summary:
    "As a Junior Software Engineer, I have successfully created services that mae it easier to detect malicious activity and prevent threat actors from accessing customer data.",
